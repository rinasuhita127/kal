...
## B. Penyelesaian Sistem Persamaan Linear dengan Oprasi Baris Elementer beserta Kode Python
...
$R_2 \leftarrow R_2 - 2R_1$, yaitu baris kedua dikurangi dua kali baris pertama sehingga elemen di kolom pertama baris kedua menjadi nol.
...
$R_2 \leftarrow -\frac{1}{3}R_2$, yaitu seluruh elemen pada baris kedua dikalikan dengan $-\frac{1}{3}$ sehingga nilai pivot yang semula $-3$ berubah menjadi $1$.
...
yaitu baris kedua dikurangi dua kali baris pertama dan baris ketiga dikurangi tiga kali baris pertama sehingga elemen pada kolom pertama di bawah pivot menjadi nol.
...
## C. Visualisasi Geometri (Geogebra)
